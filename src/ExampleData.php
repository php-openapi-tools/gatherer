...
{
    public static function gather(mixed $exampleData, Representation\Property\Type $type, string $propertyName): Representation\ExampleData
    {
        ...
        if ($type->type === 'array' || $type->type === 'union') {
            ...
            } elseif ($type->payload instanceof Representation\Property\Type) {
